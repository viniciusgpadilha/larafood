...
@section('content_header')
    ...
    <h1>Categorias do produto <strong>{{ $product->title }}</strong><a href="{{ route('products.categories.available', $product->id) }}" class="ml-4 btn btn-dark"><i class="fas fa-sm fa-plus"></i>  Adicionar categoria</a></h1>
