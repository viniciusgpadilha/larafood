...
@section('content_header')
    ...
    <h1>Perfis do <strong>{{$plan->name}}</strong> <a href="{{ route('plans.profiles.available', $plan->id) }}" class="ml-3 btn btn-dark"><i class="fas fa-sm fa-plus"></i> Adicionar Novo Perfil</a></h1>
@stop
